...
- **Week 4:** CIFAR-10 Image Classification using Artificial Neural Networks (ANN) and Convolutional Neural Networks (CNN)
  with Data Augmentation & Early Stopping
- **Week 5:** Text Generation using Vanilla RNN, LSTM, and GRU with Next-Word Prediction
